...
pub(crate) const ENEMY_DEFS: &[EnemyDef] = &[
    ...
    EnemyDef { kind: EK_GUN2, name: "M870K case", role: "pickup", hp: 1, radius: 0.22, zoff: 34.0, scale: 0.48, texture: T_GUN2, sheet4: false, hostile: false, cleared_on_wave: false },
    EnemyDef { kind: EK_GUN3, name: "VX-9 case", role: "pickup", hp: 1, radius: 0.22, zoff: 34.0, scale: 0.46, texture: T_GUN3, sheet4: false, hostile: false, cleared_on_wave: false },
    EnemyDef { kind: EK_GUN4, name: "SHRIKE case", role: "pickup", hp: 1, radius: 0.22, zoff: 34.0, scale: 0.54, texture: T_GUN4, sheet4: false, hostile: false, cleared_on_wave: false },
    EnemyDef { kind: EK_GUN5, name: "RAVEN case", role: "pickup", hp: 1, radius: 0.22, zoff: 34.0, scale: 0.50, texture: T_GUN5, sheet4: false, hostile: false, cleared_on_wave: false },
    EnemyDef { kind: EK_GUN6, name: "ARC-12 case", role: "pickup", hp: 1, radius: 0.22, zoff: 34.0, scale: 0.52, texture: T_GUN6, sheet4: false, hostile: false, cleared_on_wave: false },
    EnemyDef { kind: EK_GUN7, name: "M56 case", role: "pickup", hp: 1, radius: 0.24, zoff: 34.0, scale: 0.60, texture: T_GUN7, sheet4: false, hostile: false, cleared_on_wave: false },
